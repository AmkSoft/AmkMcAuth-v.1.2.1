...
//    // Deze 4 regels toegevoegd om te zien of het filter zo wel werkt!!! 
//    private final AmkMcAuth plugin;
//    public AmkMcAuth(AmkMcAuth instance) {
...
//    }
    ...
    public void onEnable() {
        ...
        //this.plugin.getServer().getLogger().setFilter(MyFilter); // Proef met 'plugin', zie boven aan.

        //this.log.setFilter(new LogFilter()); 

		for (Plugin p : getServer().getPluginManager().getPlugins()) {
			String pname = p.toString();
			//this.getLogger().info("Found Plugin: " + pname); // Debug..
			if(pname.contains("AmkMcAuth")) p.getLogger().setFilter(MyFilter);
		}
